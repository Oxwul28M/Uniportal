            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        <template x-for="reg in requests.filter(r => search === '' || r.name.toLowerCase().includes(search.toLowerCase()))" :key="reg.id">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500 student-email" x-text="reg.email"></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                        ...
                        <template x-if="requests.filter(r => search === '' || r.name.toLowerCase().includes(search.toLowerCase())).length === 0">
                            <tr>
