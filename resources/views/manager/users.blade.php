<x-dashboard-layout>
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Administra los accesos y registros de estudiantes y docentes en el portal.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="group flex flex-col gap-3 rounded-2xl p-6 bg-white border border-gray-200 shadow-sm transition-all hover:shadow-md">
            <div class="flex items-center justify-between">
                ...
                <div class="w-10 h-10 rounded-xl bg-brand-50 text-brand-700 flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sticky top-24">
                ...
                <form action="{{ route('manager.users.store') }}" method="POST" class="space-y-4" x-data="{ loading: false }" @submit="loading = true">
                    ...
                    <div>
                        ...
                        <select name="role" required class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-brand-800/20 focus:border-brand-800 transition-all">
                    ...
                    <button type="submit" :disabled="loading" class="w-full py-3 mt-2 bg-gradient-to-r from-brand-800 to-blue-600 hover:from-brand-900 hover:to-blue-700 text-white rounded-xl text-sm font-semibold transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="p-6 border-b border-gray-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <form action="{{ route('manager.users.index') }}" method="GET" class="flex gap-2 w-full sm:w-auto">
                        ...
                        <button type="submit" class="p-2.5 bg-brand-50 text-brand-700 rounded-xl hover:bg-brand-100 transition-all border border-brand-100">
                    ...
                    <table class="w-full text-left">
                        <thead class="bg-gray-50 border-b border-gray-100">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider text-center">Rol</th>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center font-bold text-gray-500 text-xs uppercase border border-gray-200" x-text="user.name.substring(0,2)">
                                            </div>
                                            <div>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <button @click="editingUser = Object.assign({}, user)" class="p-2 bg-white border border-gray-200 text-gray-500 rounded-lg hover:text-brand-700 hover:border-brand-200 hover:bg-brand-50 transition-all shadow-sm">
                ...
                <template x-teleport="body">
                    <div x-show="editingUser" x-cloak
                        ...
                        <div class="absolute inset-0 bg-gray-900/40 backdrop-blur-sm transition-opacity" @click="editingUser = null"></div>
                        ...
                        <div class="bg-white rounded-3xl w-full max-w-md shadow-2xl relative overflow-hidden"
                            ...
                            <form @submit.prevent="updateUser($event)" class="p-8 space-y-5">
                                ...
                                <div class="space-y-1.5 pt-2">
                                    <label class="text-sm font-semibold text-gray-700">Nueva Contraseña <span class="text-xs text-gray-400 font-normal">(Opcional)</span></label>
                                ...
                                <div class="pt-4">
                                    <button type="submit" :disabled="loadingAction === 'update-user'"
                                        ...
                                        <span x-text="loadingAction === 'update-user' ? 'Guardando cambios...' : 'Guardar Cambios'"></span>
                                    </button>
                                </div>
                            </form>
                        </div>
